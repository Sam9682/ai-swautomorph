...
print_warning "     - modify ./conf/deploy.ini with your platform settings"
print_warning "     - add ssl certificate in ~/ai-swautomorph/ssl/certificate_domain.crt"
print_warning "     - add ssl private key in ~/ai-swautomorph/ssl/privateKey_domain.key"