...
def dashboard():
    ...
    for app in applications_raw:
        app_id, app_name, db_url, description, git_url, git_repo_size, docker_build_duration, docker_start_duration, docker_stop_duration, docker_ps_duration = app
        
        # Use the URL stored in the database instead of calculating it
        applications.append((app_id, app_name, db_url, description, git_url, git_repo_size or 50, docker_build_duration, docker_start_duration or 30, docker_stop_duration or 10, docker_ps_duration))
