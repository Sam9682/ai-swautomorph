...
TRANSLATIONS = {
    'en': {
        ...
        'app_is_running': 'Application is running',
        'app_is_not_running': 'Application is not running',
        'first_clone': 'Clone for the first time',
        'clone': 'Clone',
        'reclone': 're-Clone',
    ...
    'fr': {
        ...
        'app_is_not_running': 'L\'application ne tourne pas actuellement',
        'app_is_running': 'L\'application tourne actuellement',
        ...
        'why_choose_ai': 'Pourquoi Choisir l\'IA Plutôt que l\'IT Humaine',
        'cost_savings': 'Économies de Coûts',
        'cost_savings_desc': 'Pas de salaires, d\'avantages sociaux ou de coûts de formation',
        ...
        'instant_response_desc': 'Pas d\'attente dans les files de tickets ou de planification de réunions',
        'perfect_execution': 'Exécution Parfaite',
        'perfect_execution_desc': 'Pas d\'erreurs humaines, qualité constante à chaque fois',
        ...
        'always_learning_desc': 'Les agents IA s\'améliorent à chaque interaction',
        'disruption_warning': 'L\'industrie IT est en cours de disruption MAINTENANT. Les entreprises utilisant des agents IA avancent 10 fois plus vite que celles qui dépendent encore d\'équipes IT humaines. Ne vous laissez pas distancer.',
        'configuration': 'Configuration',
