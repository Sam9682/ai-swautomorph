...
TRANSLATIONS = {
    'en': {
        ...
        'devops_teams': 'DevOps Teams',
        'devops_teams_desc': 'Multi-server deployment with automated lifecycle management',
        'key_features': 'Key Features',
        'virtual_agents': 'Virtual Agents',
        'virtual_agents_desc': 'AI Developer & DevOps assistants for code and deployment',
    ...
    'fr': {
        ...
        'devops_teams': 'Équipes DevOps',
        'devops_teams_desc': 'Déploiement multi-serveurs avec gestion automatisée du cycle de vie',
        'key_features': 'Fonctionnalités Clés',
        'virtual_agents': 'Agents Virtuels',
        'virtual_agents_desc': 'Assistants IA Développeur et DevOps pour le code et le déploiement',
